...
#if LV_TICK_CUSTOM
    #define LV_TICK_CUSTOM_INCLUDE "System_time.h"         /*Header for the system time function*/
    #define LV_TICK_CUSTOM_SYS_TIME_EXPR (Get_System_T().ms)    /*Expression evaluating to current system time in ms*/
...
#define LV_USE_BTNMATRIX  1 //矩阵按钮
...
#define LV_USE_DROPDOWN   0 //下拉菜单  /*Requires: lv_label*/

#define LV_USE_IMG        1 //图片 /*Requires: lv_label*/
...
#if LV_USE_LABEL
    #define LV_LABEL_TEXT_SELECTION 1 /*Enable selecting text of the label启用选择标签的文本*/
    #define LV_LABEL_LONG_TXT_HINT 1  /*Store some extra info in labels to speed up drawing of very long texts在标签中存储一些额外的信息，以加快绘制非常长的文本*/
#endif

#define LV_USE_LED        0 //LED

#define LV_USE_LINE       0 //线

#define LV_USE_LIST       1 //列表

#define LV_USE_MENU       0 //菜单

#define LV_USE_METER      0//仪表

#define LV_USE_MSGBOX     1//消息框

#define LV_USE_ROLLER     1 //滚轮控件  /*Requires: lv_label*/

#define LV_USE_SLIDER     1 //滑 块  /*Requires: lv_bar*/
...
#define LV_USE_SPINNER    1 //环形加载器

#define LV_USE_SWITCH     1 //开关

#define LV_USE_TEXTAREA   1 //文本区域  /*Requires: lv_label*/
#if LV_USE_TEXTAREA != 0
    #define LV_TEXTAREA_DEF_PWD_SHOW_TIME 1500    /*ms*/
#endif

#define LV_USE_TABLE      0 //表

#define LV_USE_TABVIEW    0 //标签视图
